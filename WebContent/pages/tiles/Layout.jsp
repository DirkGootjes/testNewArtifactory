...
<c:set var="buildDate" value="${applicationScope['Implementation-Build']}" scope="request" />
...
<script type="text/javascript"
	src="<c:out value='${contextPath}' />/dwr/interface/CommonJS.js?version=<c:out value='${buildDate}' />"></script>
<script type="text/javascript"
	src="<c:out value='${contextPath}' />/dwr/engine.js?version=<c:out value='${buildDate}' />"></script>
<script type="text/javascript"
	src="<c:out value='${contextPath}' />/js/common.js?version=<c:out value='${buildDate}' />"></script>
<script>
...
<div id='bodyDiv' class='container'><tiles:insert attribute="body" /></div>
<br>
<div style="width:80%">
<table width=100% cellspacing=0 cellpadding=0 border=0>
	<tr>
